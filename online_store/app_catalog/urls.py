...
from .views import IndexView, ProductListView, product_detail_view, SearchProductsView
...
urlpatterns = [
    ...
    path('catalog/search_products/', SearchProductsView, name='search_products'),
