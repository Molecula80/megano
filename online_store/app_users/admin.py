...
class UserAdmin(admin.ModelAdmin):
    ...
    def assign_staff_status(self, request, queryset):
        queryset.update(is_staff=True)

    def deprive_staff_status(self, request, queryset):
        queryset.update(is_staff=False)

    def assign_superuser_status(self, request, queryset):
        queryset.update(is_superuser=True)

    def deprive_superuser_status(self, request, queryset):
